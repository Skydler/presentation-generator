...
import { Attraction } from "@/pages/PdfCreator";

export type ContentPage = { attraction: Attraction };
type PluralisDocumentProps = { products: ContentPage[] };
export function PluralisDocument({ products }: PluralisDocumentProps) {
  return (
